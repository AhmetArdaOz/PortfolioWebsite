...
const items = [
  {
    id: 1,
    title: " Iskur Mobile App",
    img: "https://www.hibedestek.com.tr/wp-content/uploads/2015/04/i%C5%9Fkur.png",
    desc: "In the organization I work for, we were tasked with renewing the İŞKUR mobile application. The backend development involved reorganizing existing APIs and developing new ones using .NET technology to enhance performance and security. For the frontend, the application was completely redesigned and developed using React Native CLI, integrating various UI components and libraries to ensure a user-friendly interface and smooth mobile operation. The project aimed to deliver a faster, more secure, and more user-friendly mobile application, significantly improving both the technical infrastructure and user experience.",
  },
  {
    id: 2,
